<!-- ───────────────── 강의 음성 기반 보완 제안 ─────────────────
  이 파일의 제안 13건 (개념보강 2 / 결과해석 3 / 그림해설 7 / 실무맥락 1)
...
<!-- +강의 id=4.1_단일출력의한계-01 w=w6 ts=[15:53] [16:18] 유형=결과해석 채택=? -->
...
<!-- +강의 id=4.1_단일출력의한계-02 w=w6 ts=[34:03] [34:35] [36:26] 유형=결과해석 채택=? -->
...
<!-- +강의 id=4.1_단일출력의한계-03 w=w6 ts=[57:43] 유형=실무맥락 채택=? -->
...
<!-- +강의 id=4.1_단일출력의한계-04 w=w6 ts=[60:19] [61:11] 유형=그림해설 채택=? -->
...
<!-- +강의 id=4.1_단일출력의한계-05 w=w6 ts=[62:48] 유형=그림해설 채택=? -->
...
<!-- +강의 id=4.1_단일출력의한계-06 w=w6 ts=[68:14] [69:01] 유형=결과해석 채택=? -->
...
<!-- +강의 id=4.1_단일출력의한계-07 w=w6 ts=[72:53] [73:40] 유형=그림해설 채택=? -->
...
<!-- +강의 id=4.1_단일출력의한계-08 w=w6 ts=[73:40] [74:29] 유형=그림해설 채택=? -->
...
<!-- +강의 id=4.1_단일출력의한계-09 w=w6 ts=[75:15] 유형=그림해설 채택=? -->
...
<!-- +강의 id=4.1_단일출력의한계-10 w=w6 ts=[61:11] 유형=개념보강 채택=? -->
...
<!-- +강의 id=4.1_단일출력의한계-11 w=w6 ts=[67:28] [71:20] 유형=그림해설 채택=? -->
...
<!-- +강의 id=4.1_단일출력의한계-12 w=w6 ts=[69:46] [70:35] 유형=개념보강 채택=? -->
...
<!-- +강의 id=4.1_단일출력의한계-13 w=w6 ts=[75:15] 유형=그림해설 채택=? -->
