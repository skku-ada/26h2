<!-- ───────────────── 강의 음성 기반 보완 제안 ─────────────────
  이 파일의 제안 18건 (결과해석 1 / 그림해설 16 / 실무맥락 1)
...
<!-- +강의 id=2.3_선형투영의실패-01 w=w3 ts=[01:35] [02:03] [02:29] 유형=그림해설 채택=? -->
...
<!-- +강의 id=2.3_선형투영의실패-02 w=w3 ts=[06:13] [11:22] 유형=그림해설 채택=? -->
...
<!-- +강의 id=2.3_선형투영의실패-03 w=w3 ts=[14:08] [14:59] 유형=그림해설 채택=? -->
...
<!-- +강의 id=2.3_선형투영의실패-04 w=w3 ts=[14:08] [15:50] 유형=그림해설 채택=? -->
...
<!-- +강의 id=2.3_선형투영의실패-05 w=w3 ts=[14:08] [16:43] 유형=그림해설 채택=? -->
...
<!-- +강의 id=2.3_선형투영의실패-06 w=w3 ts=[27:54] [28:20] [28:41] 유형=그림해설 채택=? -->
...
<!-- +강의 id=2.3_선형투영의실패-07 w=w3 ts=[30:09] 유형=그림해설 채택=? -->
...
<!-- +강의 id=2.3_선형투영의실패-08 w=w3 ts=[67:31] 유형=실무맥락 채택=? -->
...
<!-- +강의 id=2.3_선형투영의실패-09 w=w3 ts=[35:02] [35:23] 유형=그림해설 채택=? -->
...
<!-- +강의 id=2.3_선형투영의실패-10 w=w3 ts=[35:23] [36:25] [36:49] 유형=그림해설 채택=? -->
...
<!-- +강의 id=2.3_선형투영의실패-11 w=w3 ts=[33:39] [35:56] [36:49] 유형=그림해설 채택=? -->
...
<!-- +강의 id=2.3_선형투영의실패-12 w=w3 ts=[40:36] [41:25] 유형=결과해석 채택=? -->
...
<!-- +강의 id=2.3_선형투영의실패-13 w=w3 ts=[51:45] 유형=그림해설 채택=? -->
...
<!-- +강의 id=2.3_선형투영의실패-14 w=w3 ts=[51:45] [52:34] 유형=그림해설 채택=? -->
...
<!-- +강의 id=2.3_선형투영의실패-15 w=w3 ts=[53:20] 유형=그림해설 채택=? -->
...
<!-- +강의 id=2.3_선형투영의실패-16 w=w3 ts=[54:06] [54:36] 유형=그림해설 채택=? -->
...
<!-- +강의 id=2.3_선형투영의실패-17 w=w3 ts=[58:40] [59:08] [59:38] 유형=그림해설 채택=? -->
...
<!-- +강의 id=2.3_선형투영의실패-18 w=w3 ts=[71:30] [72:17] 유형=그림해설 채택=? -->
