<!-- ───────────────── 강의 음성 기반 보완 제안 ─────────────────
  이 파일의 제안 20건 (개념보강 1 / 결과해석 3 / 그림해설 16)
...
- 7.1.17 TCAV: 학습된 표현이 인코딩한 개념 — 실습 7.1.8
...
<!-- +강의 id=7.1_기여도분석-01 w=w13 ts=[56:44] [57:05] [57:45] [58:13] 유형=그림해설 채택=? -->
...
<!-- +강의 id=7.1_기여도분석-02 w=w13 ts=[59:52] 유형=그림해설 채택=? -->
...
<!-- +강의 id=7.1_기여도분석-03 w=w13 ts=[63:50] [64:37] 유형=그림해설 채택=? -->
...
<!-- +강의 id=7.1_기여도분석-04 w=w13 ts=[67:39] 유형=그림해설 채택=? -->
...
<!-- +강의 id=7.1_기여도분석-05 w=w13 ts=[66:08] [66:53] 유형=그림해설 채택=? -->
...
<!-- +강의 id=7.1_기여도분석-06 w=w13 ts=[87:33] [88:07] [88:42] [89:06] 유형=결과해석 채택=? -->
...
<!-- +강의 id=7.1_기여도분석-07 w=w14a ts=[22:15] [23:00] 유형=그림해설 채택=? -->
...
<!-- +강의 id=7.1_기여도분석-08 w=w14a ts=[29:19] [32:25] 유형=개념보강 채택=? -->
...
<!-- +강의 id=7.1_기여도분석-09 w=w14a ts=[41:15] [42:54] 유형=결과해석 채택=? -->
...
<!-- +강의 id=7.1_기여도분석-10 w=w14a ts=[74:57] [76:02] 유형=그림해설 채택=? -->
...
<!-- +강의 id=7.1_기여도분석-11 w=w14a ts=[74:28] 유형=그림해설 채택=? -->
...
<!-- +강의 id=7.1_기여도분석-12 w=w14a ts=[76:58] [77:31] 유형=그림해설 채택=? -->
...
<!-- +강의 id=7.1_기여도분석-13 w=w14a ts=[85:32] [86:02] 유형=그림해설 채택=? -->
...
<!-- +강의 id=7.1_기여도분석-14 w=w14a ts=[86:53] [87:25] 유형=그림해설 채택=? -->
...
<!-- +강의 id=7.1_기여도분석-15 w=w14b ts=[16:09] [16:40] [17:08] 유형=그림해설 채택=? -->
...
<!-- +강의 id=7.1_기여도분석-16 w=w14b ts=[18:20] [18:50] 유형=그림해설 채택=? -->
...
<!-- +강의 id=7.1_기여도분석-17 w=w14b ts=[08:27] [08:54] [19:46] 유형=그림해설 채택=? -->
...
### 실습 7.1.8 — MNIST Auto-Encoder TCAV 측정

> 노트북: `code/7.1.8.TCAV_MNIST_AE.ipynb`

**목적.** MNIST Auto-Encoder를 학습한 뒤, Encoder의 출력이 개념을 인코딩한 수준을 TCAV로 측정한다. 여기서 개념은 0~9의 숫자다.
...
한 개념에 대해 양성 80개·음성 80개를 뽑아 로지스틱 회귀를 한 번만 학습하고, 계수의 절댓값을 정규화하여 16개 $z$ 차원의 TCAV 점수를 한꺼번에 반환한다.

```python
from sklearn.linear_model import LogisticRegression

# 개념 = 0~9 숫자. 각 개념에 대해 양성 = 그 숫자, 음성 = 나머지
# 특정 개념에 대해 16개 전체 z 차원의 TCAV 점수를 한 번에 반환
...
이 함수를 10개 개념에 대해 반복하면 $10 \times 16$ 의 TCAV 행렬이 채워진다.
...
*그림 7-8. TCAV 점수가 높은 차원을 흔들면 그 개념에 해당하는 시각적 변화가 나타난다.*

<!-- +강의 id=7.1_기여도분석-18 w=w14b ts=[29:26] [30:00] [30:21] 유형=그림해설 채택=? -->
...
<!-- +강의 id=7.1_기여도분석-19 w=w14b ts=[45:48] [46:36] 유형=그림해설 채택=? -->
...
<!-- +강의 id=7.1_기여도분석-20 w=w14b ts=[63:55] [70:58] 유형=결과해석 채택=? -->
