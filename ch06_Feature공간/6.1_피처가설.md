<!-- ───────────────── 강의 음성 기반 보완 제안 ─────────────────
  이 파일의 제안 6건 (개념보강 1 / 결과해석 1 / 그림해설 3 / 실무맥락 1)
...
<!-- +강의 id=6.1_피처가설-01 w=w11 ts=[45:34] [47:06] 유형=결과해석 채택=? -->
...
<!-- +강의 id=6.1_피처가설-02 w=w11 ts=[54:29] 유형=개념보강 채택=? -->
...
<!-- +강의 id=6.1_피처가설-03 w=w11 ts=[57:49] [60:42] 유형=그림해설 채택=? -->
...
<!-- +강의 id=6.1_피처가설-04 w=w11 ts=[64:44] [66:52] [67:12] 유형=그림해설 채택=? -->
...
<!-- +강의 id=6.1_피처가설-05 w=w11 ts=[65:36] [65:54] [67:32] 유형=실무맥락 채택=? -->
...
<!-- +강의 id=6.1_피처가설-06 w=w11b ts=[09:49] [10:14] [10:34] 유형=그림해설 채택=? -->
